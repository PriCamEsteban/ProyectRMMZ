...
/*:
 * @plugindesc (v1.5 *) Apresenta as variáveis através de Huds.
 * @author Moghunter
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 ...
 * - (NEW) - Opção de desativar a função autoFade.
 * - (NEW) - Opção de desativar a função smartFade.   
 * - (BUG FIX) - Correção de não ocultar as huds.
 *  
 */
